            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <ul className="text-lg md:text-xl text-gray-400 mb-7">
              ...
              {/* Content    <li className="flex items-center mb-2">
                  ...
                  <Link href="/About">
          <button className="bg-zinc-900 hover:bg-sky-900 duration-300 hover:scale-105 hover:shadow-lg text-white px-6 py-4  font-bold transition">
            Mehr Erfahren
          </button>
        </Link>
                </div>
